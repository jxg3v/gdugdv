...
$sudo = array("5099564264","0000","0000");
...
if(preg_match("/@/",$text) and $Host['mode'] == "AFTU2") {
bot('sendMessage',[
'chat_id'=>$admin,
'text'=>"
...
" ,
        ...
        bot("sendMessage", [
            "chat_id" => explode("|", $data)[1] ,
            "text" => "
*- تم رفض طلب ترقية حسابك لأسباب معينة ❌ ❕ *
",
            "parse_mode" => "markdown", 
...
if ($UploadEr["mems"][$from_id] == null) {
 ...
 bot("sendMessage", [
            "chat_id" => $chat_id ,
            "text" => "
*☑️ - يرجى طلب ترقية حسابك في البوت من قبل Dev ✓ المطور حتى تستطيع استخدام البوت ⚙️

- لارسال طلب ترقية حسابك ارسل /Yasin*
",
            "parse_mode" => "markdown", 
        ]);
        return false ;
...
🤔] تعليمات البوت /help
     ...
     [['text'=>"حساب: المطور",'url'=>"https://t.me/GJEGG" ]], 
      ]
    ])
            ]);
				} 
